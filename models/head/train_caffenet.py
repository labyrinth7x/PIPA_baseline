...
def get_network(args):
    ...
    flatten0_output = all_layers['relu7_output']
    ...
    weight_256 = mx.sym.Variable('embed_weight', init= weight_net_init, shape = (args.embed_size,4096),lr_mult = args.lr_mult)
...
def parse_args():
    ...
    parser.add_argument('--train_root', type=str, default='/mnt/data-1/data/qi01.zhang/COCO/data/head/lst_origin/train.rec', help='train root')
