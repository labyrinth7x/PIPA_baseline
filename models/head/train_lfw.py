...
def get_network(args):
    ...
    weight_softmax = mx.sym.Variable('fc1_weight', shape = (5749,args.embed_size), lr_mult = args.lr_mult, init = weight_softmax_init)
    net_softmax = mx.sym.FullyConnected(data = net, weight = weight_softmax, num_hidden = 5749, name = 'fc1', no_bias = True)
...
def record(args):
    ...
    record.write('aug_level:%d'%args.aug_level + '\n')
