...
def parse_args():
    ...
    parser.add_argument('--test0_root', type=str, default ='/mnt/data-1/data/qi01.zhang/COCO/data/lst/test0.rec')
    parser.add_argument('--test1_root', type=str, default='/mnt/data-1/data/qi01.zhang/COCO/data/lst/test1.rec')
